...
public class MovieController {
    ...
    public ModelAndView hotMovies(ModelAndView model){
        List<MoviesWithBLOBs> hotMovies = movieService.selectHotMovies();
        model.addObject("hotMovies",hotMovies);
        model.setViewName("hotMovies");
        return model;
    }
}
