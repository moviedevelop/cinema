    ...
    <div class="drop-navigation drop-navigation">
        <ul class="nav nav-sidebar">
            ...
            <ul class="cl-effect-2">
                <li><a href="/cinema/movies.jsp">English</a></li>
                <li><a href="/cinema/movies.jsp">Chinese</a></li>
                <li><a href="/cinema/movies.jsp">Hindi</a></li>
            </ul>
            <!-- script-for-menu -->
            <script>
            ...
            <li><a href="#" class="menu"><span class="glyphicon glyphicon-film glyphicon-king"
                                               aria-hidden="true"></span>Sports<span
                    class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
    ...
    <div class="main-grids">
        ...
        <div class="recommended">
            <div class="recommended-grids">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/r1.jpg" alt=""/></a>
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/r2.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>3:02</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/r3.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>1:34</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/r4.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>2:09</p>
                        </div>
                        <div class="clck small-clck">
            ...
            <div class="recommended-grids">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/r5.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>7:34</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/r6.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>6:09</p>
                        </div>
                        <div class="clck small-clck">
        ...
        <div class="recommended">
            <div class="recommended-grids">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/g.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>7:30</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/g1.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>9:34</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/g2.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>5:34</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/g3.jpg" alt=""/></a>
                        <div class="time small-time">
                            <p>6:55</p>
                        </div>
                        <div class="clck small-clck">
            ...
            <div class="recommended-grids">
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/we2.jpg" alt=""></a>
                        <div class="time small-time">
                            <p>7:30</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/we1.jpg" alt=""></a>
                        <div class="time small-time">
                            <p>9:34</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/we4.jpg" alt=""></a>
                        <div class="time small-time">
                            <p>5:34</p>
                        </div>
                        <div class="clck small-clck">
                ...
                <div class="col-md-3 resent-grid recommended-grid">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="/cinema/single.jsp"><img src="/cinema/images/we3.jpg" alt=""></a>
                        <div class="time small-time">
                            <p>6:55</p>
                        </div>
                        <div class="clck small-clck">
        ...
        <div class="footer-grids">
            <div class="footer-top">
                ...
                <div class="footer-bottom-nav">
                    <ul>
                        <li><a href="/cinema/terms.jsp">Terms</a></li>
                        <li><a href="/cinema/privacy.jsp">Privacy</a></li>
                        <li><a href="#small-dialog4" class="play-icon popup-with-zoom-anim">Send feedback</a></li>
                        <li><a href="/cinema/privacy.jsp">Policy & Safety </a></li>
            ...
            <div class="footer-bottom">
                <ul>
                    ...
                    <li><a href="/cinema/history.jsp" class="f-history">History</a></li>
