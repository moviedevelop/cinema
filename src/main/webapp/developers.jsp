			...
			<div class="developers-grids">
				...
				<div class="container">
					<div class="developers-grid">
						<a href="WEB-INF/view/single.jsp">Demos</a>
					...
					<div class="developers-grid">
						<a href="WEB-INF/view/single.jsp">API Resources</a>
					...
					<div class="developers-grid">
						<a href="WEB-INF/view/single.jsp">Showcase</a>
					...
					<div class="developers-grid">
						<a href="WEB-INF/view/single.jsp">Developer Stories</a>
					...
					<div class="footer-top">
						...
						<div class="footer-bottom-nav">
							<ul>
								...
								<li><p>Copyright &copy; 2015.Company name All rights reserved.</li>
							</ul>
						</div>
					</div>
